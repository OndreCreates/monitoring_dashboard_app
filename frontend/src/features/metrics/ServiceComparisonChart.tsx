...
/**
 * One metric, all services in a single chart — complements MetricChart (one service,
 * all metrics). Same merge-REST-baseline-with-live-SSE-events pattern as ResponseTimeChart.
 */
